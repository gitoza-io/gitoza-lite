...
- README **Tickets** and **AI-generated tickets** demo videos (muted, compressed)

### Changed

- README intro focuses on repo-native tasks/tests and git collaboration; About section clarifies Lite vs Desktop on the same YAML
